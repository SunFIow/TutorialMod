package com.sunflow.tutorialmod.blocks.model;
...
public class FancyBakedModel implements IDynamicBakedModel {
	...
	private TextureAtlasSprite getTexture() {
		String name = TutorialMod.MODID + ":block/fancyblock";
...
//		}
	...
	private ItemTransformVec3f getTransform(TransformType type) {
		if (type.equals(TransformType.GUI)) {
			return new ItemTransformVec3f(new Vector3f(200, 50, 100), new Vector3f(), new Vector3f(0.9F, 0.9F, 0.9F));
