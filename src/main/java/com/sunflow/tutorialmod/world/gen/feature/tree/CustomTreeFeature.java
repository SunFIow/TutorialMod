...
public class CustomTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
	...
	public CustomTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory, boolean doBlockNotifyOnPlace, boolean vinesGrow, int minTreeHeight, int randomTreeHeight, IPlantable sapling, BlockState trunkState, BlockState leafState) {
		super(configFactory, doBlockNotifyOnPlace);
...
//				int k2 = 0;
	...
	protected int getHeight(Random random) {
		return this.minTreeHeight + random.nextInt(this.randomTreeHeight);
	}
