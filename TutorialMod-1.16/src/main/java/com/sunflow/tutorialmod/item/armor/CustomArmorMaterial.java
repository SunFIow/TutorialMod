...
//   });
	...
	RUBY("ruby", 15, new int[] { 2, 5, 6, 2 }, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> Ingredient.fromItems(Registration.RUBY.get()));
	...
	private CustomArmorMaterial(String nameIn, int maxDamageFactorIn, int[] damageReductionAmountsIn, int enchantabilityIn, SoundEvent equipSoundIn, float toughness, float p_i231593_9_, Supplier<Ingredient> repairMaterialSupplier) {
		this.name = nameIn;
