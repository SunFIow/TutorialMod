...
public class TEstonTileEntity extends PistonTileEntity {
	...
	private CompoundNBT pistonTE;

	public TEstonTileEntity() { super(); }

	public TEstonTileEntity(BlockState pistonStateIn, Direction pistonFacingIn, boolean extendingIn, boolean shouldHeadBeRenderedIn, CompoundNBT pistonTE) {
		...
		this.pistonTE = pistonTE;
	}

	@Override
	public TileEntityType<?> getType() { return Registration.TESTON_TILE.get(); }
	 ...
	 */
	@Override
	public boolean isExtending() { return this.extending; }

	@Override
	public Direction getFacing() { return this.pistonFacing; }

	@Override
	public boolean shouldPistonHeadBeRendered() { return this.shouldHeadBeRendered; }
	...
	private BlockState getCollisionRelatedBlockState() {
		return !this.isExtending() && this.shouldPistonHeadBeRendered() && this.pistonState.getBlock() instanceof PistonBlock
				? Blocks.PISTON_HEAD.getDefaultState()
						.with(PistonHeadBlock.SHORT, Boolean.valueOf(this.progress > 0.25F))
						.with(PistonHeadBlock.TYPE, this.pistonState.isIn(Blocks.STICKY_PISTON) ? PistonType.STICKY : PistonType.DEFAULT)
						.with(PistonHeadBlock.FACING, this.pistonState.get(PistonBlock.FACING))
				: this.pistonState;
	}
	...
	private static void func_227022_a_(Direction p_227022_0_, Entity p_227022_1_, double p_227022_2_, Direction p_227022_4_) {
		...
		p_227022_1_.move(MoverType.PISTON, new Vector3d(p_227022_2_ * p_227022_4_.getXOffset(), p_227022_2_ * p_227022_4_.getYOffset(), p_227022_2_ * p_227022_4_.getZOffset()));
...
// ------------------------------------------------------------------------------------
				if (pistonTE != null) this.world.setTileEntity(this.pos, TileEntity.readTileEntity(pistonState, pistonTE));
// ------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------
		this.pistonTE = nbt.getCompound("pistonTE");
//------------------------------------------------------------------------------------------
	}
...
//------------------------------------------------------------------------------------------
		compound.put("pistonTE", this.pistonTE);
//------------------------------------------------------------------------------------------
		return compound;
	}
