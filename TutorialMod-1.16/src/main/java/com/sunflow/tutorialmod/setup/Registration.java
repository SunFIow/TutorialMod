...
// TODO: Looking for improvments
	...
	public static final RegistryObject<CustomLogBlock> COPPER_LOG = BLOCKS.register("copper_log", () -> new CustomLogBlock(MaterialColor.ORANGE_TERRACOTTA, Block.Properties.create(Material.WOOD, MaterialColor.ORANGE_TERRACOTTA).hardnessAndResistance(2F).sound(SoundType.WOOD)));
...
//	public static final RegistryObject<Item> ALUMINIUM_INGOT = ITEMS.register("aluminium_ingot", ItemUtil::Default);	
	...
	public static final RegistryObject<CustomLogBlock> ALUMINIUM_LOG = BLOCKS.register("aluminium_log", () -> new CustomLogBlock(MaterialColor.LIGHT_GRAY, Block.Properties.create(Material.WOOD, MaterialColor.LIGHT_GRAY).hardnessAndResistance(2F).sound(SoundType.WOOD)))));
