...
public class RubyOre extends CustomOreBlock {
	...
	public RubyOre() { super(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE).hardnessAndResistance(3).harvestLevel(2).lightValue(2)); }
