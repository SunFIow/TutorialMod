...
public class ComplexMultipartTile extends TileEntity {
	...
	private void updateState() {
		...
		world.setBlockState(pos, state
				.with(ComplexMultipartBlock.NORTH, north)
				.with(ComplexMultipartBlock.SOUTH, south)
				.with(ComplexMultipartBlock.WEST, west)
				.with(ComplexMultipartBlock.EAST, east)
				.with(ComplexMultipartBlock.UP, up)
				.with(ComplexMultipartBlock.DOWN, down),
