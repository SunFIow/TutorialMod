...
public class DefaultConfigScreen extends Screen {
	...
	public DefaultConfigScreen(String title, Screen parentScreen, AbstractOption... options) {
		this(new StringTextComponent(title), parentScreen, options);
	}

	public DefaultConfigScreen(ITextComponent title, Screen parentScreen, AbstractOption... options) {
		super(title);
