...
public class RunDownHousePieces {
	 ...
	 */
	private static final ResourceLocation LEFT_SIDE = new ResourceLocation(TutorialMod.MODID + ":run_down_house_left_side");
	private static final ResourceLocation RIGHT_SIDE = new ResourceLocation(TutorialMod.MODID + ":run_down_house_right_side");
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
			super(Registration.RDHP, tagCompound);
